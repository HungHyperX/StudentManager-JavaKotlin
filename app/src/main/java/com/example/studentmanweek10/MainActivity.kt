...
class MainActivity : AppCompatActivity() {
    ...
    private val students = mutableListOf(
        StudentModel("Phạm Lưu Minh Hùng", "SV001"),
        StudentModel("Phan Hoàng", "SV002"),
        StudentModel("Sang Trần", "SV003"),
        StudentModel("Phạm Thị Dung Môi", "SV004"),
        StudentModel("Trọng Vọng", "SV005"),
        StudentModel("Hoa Mĩ", "SV006"),
        StudentModel("Nguyễn Văn Hải", "SV007"),
        ...
        StudentModel("Văn Nam Long", "SV014"),
        StudentModel("Hoàng Thị Hường", "SV015"),
